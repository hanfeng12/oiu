#ifndef HALIDE__comp___elastic_transform_h
#define HALIDE__comp___elastic_transform_h
#include <stdint.h>
...
int halide_elastic_transform(struct halide_buffer_t *_p50_buffer, struct halide_buffer_t *_p51_buffer, struct halide_buffer_t *_elastic_transform_buffer);

HALIDE_FUNCTION_ATTRS
int halide_elastic_transform_argv(void **args);

HALIDE_FUNCTION_ATTRS
const struct halide_filter_metadata_t *halide_elastic_transform_metadata();
